...
function collectName(){
    ...
    // let clickBuuton2 = document.createElement("button");
    name = document.querySelector("#Name").value;
    // let courseNUmber = (Number(document.querySelector("#courseNum").value))*2;
...
function pot(){
    ...
    // console.log(real);
    // creating an array that the length is know but it is empty
    // let course = new Array (real);
    let course = [];
    let courseGrade = [];
    ...
    // console.log(courseGrade[2] + courseGrade[3]);
    // console.log(course);
